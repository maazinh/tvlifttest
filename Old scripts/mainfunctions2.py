...
def CalculateLift(df1, df2, medium, attributionwindow):
    ...
    # if medium == "MBC 2" and dfFiltered["mm"][1] == 11:
    #     beforeAd2.to_csv(
...
def CalculateLift2(df1, df2, medium, attributionwindow, i, dimension):
    ...
    # define df1 and df2
    df1 = df1[["country", "sector", "category", "product", "brand", "subbrand", "tv_program_name", "tv_spot_start_time_hour", "total_breaks_in_program", "spot_number", "total_spots_in_break", "ad_language", "medium", "space", "amount", "spot_position", "DateJoin"]]
    df2 = df2
